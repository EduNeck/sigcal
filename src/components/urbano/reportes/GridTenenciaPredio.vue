<template>
    <v-container>
      <v-card class="mx-auto block-color" max-width="1800">
        <v-card-title class="d-flex justify-center"><h3>CERTIFICADO TENENCIA PREDIOS</h3></v-card-title>
    ...
    data() {
      return {
        ...
        headers: [
          ...
          { text: 'Clave Catastral', value: 'tipo_predio' },
        ...
        items: [
          ...
          // Ejemplo:
          {
            ...
            tipo_predio: '1004012520302500P0000', 
