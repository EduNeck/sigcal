<template>
    <v-container>
      <v-card class="mx-auto block-color" max-width="1800">
        <v-card-title class="d-flex justify-center"><h3>PISOS REGISTRADOS</h3></v-card-title>
    ...
    data() {
      return {
        ...
        headers: [
          ...
          { text: 'Tipo Piso', value: 'tipo_piso' },
          { text: 'Área Construcción', value: 'area_construccion' },
          { text: 'Año Construcción', value: 'anio_construccion' },
          { text: 'Avalúo Predio', value: 'avaluo' },
