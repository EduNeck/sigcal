    ...
    <v-container class="mt-1">
      ...
      <v-menu offset-y> 
        <template v-slot:activator="{ on, attrs }"> 
          <v-btn color="primary" dark class="mb-3" v-bind="attrs" v-on="on" @click="navigateToVisor('rural')"> 
            Visor
          </v-btn> 
        </template>               
      </v-menu>             
      ...
      <v-menu offset-y> 
        <template v-slot:activator="{ on, attrs }"> 
          <v-btn color="green" dark class="mb-3" v-bind="attrs" v-on="on" @click="$router.push('/valora-rural')"> 
            Valoración
          </v-btn> 
        </template>               
      </v-menu>              
      ...
      <v-menu offset-y> 
        <template v-slot:activator="{ on, attrs }"> 
          <v-btn color="green" dark class="mb-3" v-bind="attrs" v-on="on" @click="$router.push('/menu-ingreso')"> 
            Salir
          </v-btn> 
        </template>               
      </v-menu>                
